        ...
        <td align="center" bgcolor="#BFA06B" class="footer_text"><table width="60%" border="0" align="left" cellpadding="5" cellspacing="0">
                <tr>
                    ...
                    <td width="10%"><table width="160" border="0" align="left" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="5" align="left" valign="middle">&nbsp;</td>
                                <td width="142" height="25" align="left" valign="middle"  ><a href="<?php echo base_url();?>booking/pendingCheckout" style="color:#FFF;" class="white_heading_txt_16px">Pending Checkout<span id="penco" style="color:#C92020">(0)</span></a></td>
                            </tr>
                            <tr>
                                <td height="1" colspan="2" ></td>
                            </tr>
                    ...
                    <td width="10%"><table width="140" border="0" align="left" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="5" align="left" valign="middle">&nbsp;</td>
                                <td width="142" height="25" align="left" valign="middle"  ><a href="<?php echo base_url();?>booking/replaceRoom" style="color:#FFF;" class="white_heading_txt_16px">Room Replace</a></td>
                            </tr>
                            <tr>
                                <td height="1" colspan="2" ></td>
                            </tr>
            ...
            <table border="0" align="right" cellpadding="0" cellspacing="0" width="98%">
                <tr>
                    ...
                    if($this->session->userdata('user_details')) {
                        ?>
                    <td width="127" align="right" valign="middle"><?php echo ucfirst($this->user_details->emp_fname).' '.$this->user_details->emp_lname?></td>
<?php
                    }
                    else {
                        ?>
                    ...
                    if($this->session->userdata('user_details')) {
                        ?>
                    <td width="120" height="25" align="right" valign="middle"><a href="<?php echo base_url();?>booking/changepwd" style="color:#FFF;" class="white_bold_txt_12px jlo">Change Password</a></td>
                    <td width="49" height="25" align="right" valign="middle"><a href="<?php echo base_url();?>login/logout" style="color:#FFF;"  class="white_bold_txt_12px jlo">LogOut</a></td>
                    <?php
}
else {
                        ?>
